  ...
  return (
    <div className='flex py-5 gap-3 md:gap-5 border-b'>
        ...
        <div className='border w-full flex flex-col'>
             <div className='border flex flex-col md:flex-row justify-between'>
                 <div className='boder text-lg md:text-2xl font-semibold text-black/[0.8]'>
                    {p.name}
                 </div>
                 ...
                 <div className='flex items-center gap-2 md:gap-10 text-black/[0.5] text-sm md:text-md'>
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <select className='hover:text-black' onChange={(e)=>updateCartItem(e,'quantity')}>
                            {Array.from({length:12},(_, i)=>i+1).map((q,i)=>{
                                return (
